...
def draw():
    ...
    # Рисуем белый сегмент (цвет по ГОСТу Р 51130-98)
    segment_white_color = [255] * 3
    segment_white_rect = [(30, 30), (9 * 40, 2 * 40)]
    pygame.draw.rect(screen, segment_white_color, segment_white_rect)
